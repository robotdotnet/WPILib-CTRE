...
using static CTRE.HALCanTalonSRX;
using static CTRE.HALCanTalonSRX.Constants;
...
namespace CTRE
{
    ...
    public class CANTalon : IMotorSafety, ICANSpeedController, ITableListener, IPIDOutput, IPIDSource
    {
        ...
        public CANTalon(int deviceNumber, int controlPeriodMs, int enablePeriodMs)
        {
            ...
            m_talonPointer = ctre_TalonSRX_Create3(deviceNumber, controlPeriodMs, enablePeriodMs);
        ...
        public void Dispose()
        {
            ...
            ctre_TalonSRX_Destroy(m_talonPointer);
        }
        ...
        {
            CTR_Code status = ctre_TalonSRX_SetParam(m_talonPointer, (int)paramEnum, value);
        ...
        {
            CTR_Code status = ctre_TalonSRX_SetRevFeedbackSensor(m_talonPointer, flip ? 1 : 0);
            CheckCTRStatus(status);
        }
        ...
        {
            CTR_Code status = ctre_TalonSRX_SetRevMotDuringCloseLoopEn(m_talonPointer, flip ? 1 : 0);
            CheckCTRStatus(status);
        }
        ...
        {
            int pos = 0;
            CTR_Code status = ctre_TalonSRX_GetEncPosition(m_talonPointer, ref pos);
            CheckCTRStatus(status);
            return pos;
        }
        ...
        {
            int vel = 0;
            CTR_Code status = ctre_TalonSRX_GetEncVel(m_talonPointer, ref vel);
            CheckCTRStatus(status);
            return vel;
        }
        ...
        {
            int val = 0;
            CTR_Code status = ctre_TalonSRX_GetPulseWidthPosition(m_talonPointer, ref val);
            CheckCTRStatus(status);
            return val;
        }
        ...
        {
            int val = 0;
            CTR_Code status = ctre_TalonSRX_GetPulseWidthVelocity(m_talonPointer, ref val);
            CheckCTRStatus(status);
            return val;
        }
        ...
        {
            int val = 0;
            CTR_Code status = ctre_TalonSRX_GetPulseWidthRiseToFallUs(m_talonPointer, ref val);
            CheckCTRStatus(status);
            return val;
        }
        ...
        {
            int val = 0;
            CTR_Code status = ctre_TalonSRX_GetPulseWidthRiseToRiseUs(m_talonPointer, ref val);
            CheckCTRStatus(status);
            return val;
        }
        ...
        public FeedbackDeviceStatus IsSensorPresent(FeedbackDevice feedbackDevice)
        {
            ...
            switch (feedbackDevice)
            {
                ...
                case FeedbackDevice.PulseWidth:
                    int value = 0;
                    CTR_Code status = ctre_TalonSRX_IsPulseWidthSensorPresent(m_talonPointer, ref value);
                    CheckCTRStatus(status);
                    if (value == 0)
                    {
        ...
        {
            int state = 0;
            CTR_Code status = ctre_TalonSRX_GetEncIndexRiseEvents(m_talonPointer, ref state);
            CheckCTRStatus(status);
            return state;
        }
        ...
        {
            int state = 0;
            CTR_Code status = ctre_TalonSRX_GetQuadApin(m_talonPointer, ref state);
            CheckCTRStatus(status);
            return state;
        }
        ...
        {
            int state = 0;
            CTR_Code status = ctre_TalonSRX_GetQuadBpin(m_talonPointer, ref state);
            CheckCTRStatus(status);
            return state;
        }
        ...
        {
            int state = 0;
            CTR_Code status = ctre_TalonSRX_GetQuadIdxpin(m_talonPointer, ref state);
            CheckCTRStatus(status);
            return state;
        }
        ...
        {
            int position = 0;
            CTR_Code status = ctre_TalonSRX_GetAnalogInWithOv(m_talonPointer, ref position);
            CheckCTRStatus(status);
            return position;
        }
        ...
        {
            int velocity = 0;
            CTR_Code status = ctre_TalonSRX_GetAnalogInVel(m_talonPointer, ref velocity);
            CheckCTRStatus(status);
            return velocity;
        }
        ...
        {
            int error = 0;
            CTR_Code status = ctre_TalonSRX_GetCloseLoopErr(m_talonPointer, ref error);
            CheckCTRStatus(status);
            return error;
        }
        ...
        {
            int state = 0;
            CTR_Code status = ctre_TalonSRX_GetLimitSwitchClosedFor(m_talonPointer, ref state);
            CheckCTRStatus(status);
            return state != 0;
        }
        ...
        {
            int state = 0;
            CTR_Code status = ctre_TalonSRX_GetLimitSwitchClosedRev(m_talonPointer, ref state);
            CheckCTRStatus(status);
            return state != 0;
        }
        ...
        {
            int state = 0;
            CTR_Code status = ctre_TalonSRX_GetBrakeIsEnabled(m_talonPointer, ref state);
            CheckCTRStatus(status);
            return state != 0;
        }
        ...
        {
            double temp = 0.0;
            CTR_Code status = ctre_TalonSRX_GetTemp(m_talonPointer, ref temp);
            CheckCTRStatus(status);
            return temp;
        }
        ...
        {
            double current = 0.0;
            CTR_Code status = ctre_TalonSRX_GetCurrent(m_talonPointer, ref current);
            CheckCTRStatus(status);
            return current;
        }
        ...
        {
            int throttle = 0;
            CTR_Code status = ctre_TalonSRX_GetAppliedThrottle(m_talonPointer, ref throttle);
            CheckCTRStatus(status);
        ...
        {
            double voltage = 0.0;
            CTR_Code status = ctre_TalonSRX_GetBatteryV(m_talonPointer, ref voltage);
            CheckCTRStatus(status);
            return voltage;
        }
        ...
        {
            int pos = 0;
            CTR_Code status = ctre_TalonSRX_GetSensorPosition(m_talonPointer, ref pos);
            CheckCTRStatus(status);
        ...
        public void SetPosition(double pos)
        {
            ...
            CTR_Code status = ctre_TalonSRX_SetSensorPosition(m_talonPointer, nativePos);
            CheckCTRStatus(status);
        }
        ...
        {
            int vel = 0;
            CTR_Code status = ctre_TalonSRX_GetSensorVelocity(m_talonPointer, ref vel);
            CheckCTRStatus(status);
        ...
        public Faults GetFaults()
        {
            ...
            //Temp
            var val = 0;
            var status = ctre_TalonSRX_GetFault_OverTemp(m_talonPointer, ref val);
            ...
            //Voltage
            val = 0;
            status = ctre_TalonSRX_GetFault_UnderVoltage(m_talonPointer, ref val);
            ...
            //Fwd Limit Switch
            val = 0;
            status = ctre_TalonSRX_GetFault_ForLim(m_talonPointer, ref val);
            ...
            //Rev Limit Switch
            val = 0;
            status = ctre_TalonSRX_GetFault_RevLim(m_talonPointer, ref val);
            ...
            //Fwd Soft Limit
            val = 0;
            status = ctre_TalonSRX_GetFault_ForSoftLim(m_talonPointer, ref val);
            ...
            //Rev Soft Limit
            val = 0;
            status = ctre_TalonSRX_GetFault_RevSoftLim(m_talonPointer, ref val);
        ...
        private void ApplyControlMode(ControlMode value)
        {
            ...
            ctre_TalonSRX_SetModeSelect(m_talonPointer, (int)ControlMode.Disabled);
        ...
        public FeedbackDevice FeedBackDevice
        {
            ...
            {
                int device = 0;
                CTR_Code status = ctre_TalonSRX_GetFeedbackDeviceSelect(m_talonPointer, ref device);
                CheckCTRStatus(status);
            ...
            set
            {
                ...
                CTR_Code status = ctre_TalonSRX_SetFeedbackDeviceSelect(m_talonPointer, (int)value);
                CheckCTRStatus(status);
            }
        }
        ...
        public bool ControlEnabled
        {
            ...
            set
            {
                ...
                {
                    CTR_Code status = ctre_TalonSRX_SetModeSelect(m_talonPointer, (int)ControlMode.Disabled);
                    CheckCTRStatus(status);
                    m_controlEnabled = false;
                }
                else
        ...
        public double P
        {
            get
            {
                ...
                if (m_profile == 0)
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot0_P);
                    CheckCTRStatus(status);
                }
                else
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot1_P);
                    CheckCTRStatus(status);
                }
                CheckCTRStatus(status);
                ...
                double retVal = 0;
                status = ctre_TalonSRX_GetPgain(m_talonPointer, m_profile, ref retVal);
                CheckCTRStatus(status);
                return retVal;
            }
            set
            {
                CTR_Code status = ctre_TalonSRX_SetPgain(m_talonPointer, m_profile, value);
                CheckCTRStatus(status);
        ...
        public double I
        {
            get
            {
                ...
                if (m_profile == 0)
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot0_I);

                }
                else
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot1_I);
                }
                CheckCTRStatus(status);
                ...
                double retVal = 0;
                status = ctre_TalonSRX_GetIgain(m_talonPointer, m_profile, ref retVal);
                CheckCTRStatus(status);
                return retVal;
            }
            set
            {
                CTR_Code status = ctre_TalonSRX_SetIgain(m_talonPointer, m_profile, value);
                CheckCTRStatus(status);
            }
        }
        ...
        public double D
        {
            get
            {
                ...
                if (m_profile == 0)
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot0_D);
                }
                else
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot1_D);
                }
                CheckCTRStatus(status);
                ...
                double retVal = 0;
                status = ctre_TalonSRX_GetDgain(m_talonPointer, m_profile, ref retVal);
                CheckCTRStatus(status);
                return retVal;
            }
            set
            {
                CTR_Code status = ctre_TalonSRX_SetDgain(m_talonPointer, m_profile, value);
                CheckCTRStatus(status);
            }
        }
        ...
        public double F
        {
            get
            {
                ...
                if (m_profile == 0)
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot0_F);
                }
                else
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot1_F);
                }
                CheckCTRStatus(status);
                ...
                double retVal = 0;
                status = ctre_TalonSRX_GetFgain(m_talonPointer, m_profile, ref retVal);
                CheckCTRStatus(status);
                return retVal;
            }
            set
            {
                CTR_Code status = ctre_TalonSRX_SetFgain(m_talonPointer, m_profile, value);
                CheckCTRStatus(status);
            }
        }
        ...
        public int IZone
        {
            get
            {
                ...
                if (m_profile == 0)
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot0_IZone);
                }
                else
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot1_IZone);
                }
                CheckCTRStatus(status);
                ...
                int retVal = 0;
                status = ctre_TalonSRX_GetIzone(m_talonPointer, m_profile, ref retVal);
                CheckCTRStatus(status);
                return retVal;
            }
            set
            {
                CTR_Code status = ctre_TalonSRX_SetIzone(m_talonPointer, m_profile, value);
                CheckCTRStatus(status);
            }
        }
        ...
        {
            CTR_Code status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.ePidIaccum);
            CheckCTRStatus(status);
            Timer.Delay(DelayForSolicitedSignals);

            int val = 0;
            status = ctre_TalonSRX_GetParamResponseInt32(m_talonPointer, (int)ParamID.ePidIaccum, ref val);
            CheckCTRStatus(status);
            return val;
        }
        ...
        {
            CTR_Code status = ctre_TalonSRX_SetParam(m_talonPointer, (int)ParamID.ePidIaccum, 0);
            CheckCTRStatus(status);
        }
        ...
        public double CloseLoopRampRate
        {
            get
            {
                ...
                if (m_profile == 0)
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot0_CloseLoopRampRate);
                }
                else
                {
                    status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eProfileParamSlot1_CloseLoopRampRate);
                }
                CheckCTRStatus(status);
                ...
                int retVal = 0;
                status = ctre_TalonSRX_GetCloseLoopRampRate(m_talonPointer, m_profile, ref retVal);
                CheckCTRStatus(status);
            ...
            set
            {
                ...
                CTR_Code status = ctre_TalonSRX_SetCloseLoopRampRate(m_talonPointer, m_profile, rate);
                CheckCTRStatus(status);
            }
        }
        ...
        public int Profile
        {
            ...
            set
            {
                ...
                m_profile = value;
                CTR_Code status = ctre_TalonSRX_SetProfileSlotSelect(m_talonPointer, m_profile);
                CheckCTRStatus(status);
            }
        }
        ...
        public double VoltageCompensationRampRate
        {
            ...
            {
                double retVal = 0;
                CTR_Code status = ctre_TalonSRX_GetParamResponse(m_talonPointer, (int)ParamID.eProfileParamVcompRate, ref retVal);
                CheckCTRStatus(status);
                return retVal * 1000;
            }
            set
            {
                CTR_Code status = ctre_TalonSRX_SetVoltageCompensationRate(m_talonPointer, value / 1000.0);
                CheckCTRStatus(status);
            }
        }
            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case NeutralMode.Jumper:
                        status = ctre_TalonSRX_SetOverrideBrakeType(m_talonPointer,
        ...
        public double VoltageRampRate
        {
            set
            {
                ...
                CTR_Code status = ctre_TalonSRX_SetRampThrottle(m_talonPointer, rate);
                CheckCTRStatus(status);
            }
        }
        ...
        public uint FirmwareVersion
        {
            ...
            {
                int version = 0;
                CTR_Code status = ctre_TalonSRX_GetFirmVers(m_talonPointer, ref version);
                CheckCTRStatus(status);
                return (uint)version;
            }
        }
        ...
        public double ForwardSoftLimit
        {
            ...
            {
                int retVal = 0;
                CTR_Code status = ctre_TalonSRX_GetForwardSoftLimit(m_talonPointer, ref retVal);
                CheckCTRStatus(status);
            ...
            set
            {
                ...
                CTR_Code status = ctre_TalonSRX_SetForwardSoftLimit(m_talonPointer, nativeLimitPos);
                CheckCTRStatus(status);
            }
        }
        ...
        public bool ForwardSoftLimitEnabled
        {
            ...
            {
                int retVal = 0;
                CTR_Code status = ctre_TalonSRX_GetForwardSoftEnable(m_talonPointer, ref retVal);
                CheckCTRStatus(status);
                return retVal != 0;
            }
            set
            {
                CTR_Code status = ctre_TalonSRX_SetForwardSoftEnable(m_talonPointer, value ? 1 : 0);
                CheckCTRStatus(status);
            }
        }
        ...
        public double ReverseSoftLimit
        {
            ...
            {
                int retVal = 0;
                CTR_Code status = ctre_TalonSRX_GetReverseSoftLimit(m_talonPointer, ref retVal);
                //TODO: Check official WPILib and see if they need to scale this.
                CheckCTRStatus(status);
                return retVal;
            }
            ...
            {
                int nativeLimitPos = ScaleRotationsToNativeUnits(m_feedbackDevice, value);
                CTR_Code status = ctre_TalonSRX_SetReverseSoftLimit(m_talonPointer, nativeLimitPos);
                CheckCTRStatus(status);
            }
        }
        ...
        public bool ReverseSoftLimitEnabled
        {
            ...
            {
                int retVal = 0;
                CTR_Code status = ctre_TalonSRX_GetReverseSoftEnable(m_talonPointer, ref retVal);
                CheckCTRStatus(status);
                return retVal != 0;
            }
            set
            {
                CTR_Code status = ctre_TalonSRX_SetReverseSoftEnable(m_talonPointer, value ? 1 : 0);
                CheckCTRStatus(status);
            }
        }
        ...
        {
            CTR_Code status = ctre_TalonSRX_ClearStickyFaults(m_talonPointer);
            CheckCTRStatus(status);
        }
        ...
        public void EnableLimitSwitches(bool forward, bool reverse)
        {
            ...
            CTR_Code status = ctre_TalonSRX_SetOverrideLimitSwitchEn(m_talonPointer, mask);
            if (status != CTR_Code.CTR_OKAY)
                CheckCTRStatus(status);
        }
        ...
        public bool ForwardLimitSwitchNormallyOpen
        {
            ...
            {
                int retVal = 0;
                CTR_Code status = ctre_TalonSRX_RequestParam(m_talonPointer, (int) ParamID.eOnBoot_LimitSwitch_Forward_NormallyClosed);
                CheckCTRStatus(status);
                Timer.Delay(DelayForSolicitedSignals);
                status = ctre_TalonSRX_GetParamResponseInt32(m_talonPointer,
            ...
            set
            {
                CTR_Code status = ctre_TalonSRX_SetParam(m_talonPointer, (int)ParamID.eOnBoot_LimitSwitch_Forward_NormallyClosed, value ? 0 : 1);
                CheckCTRStatus(status);
            }
        }
        ...
        public bool ReverseLimitSwitchNormallyOpen
        {
            ...
            {
                int retVal = 0;
                CTR_Code status = ctre_TalonSRX_RequestParam(m_talonPointer, (int)ParamID.eOnBoot_LimitSwitch_Reverse_NormallyClosed);
                CheckCTRStatus(status);
                Timer.Delay(DelayForSolicitedSignals);
                status = ctre_TalonSRX_GetParamResponseInt32(m_talonPointer,
            ...
            set
            {
                CTR_Code status = ctre_TalonSRX_SetParam(m_talonPointer, (int)ParamID.eOnBoot_LimitSwitch_Reverse_NormallyClosed, value ? 0 : 1);
                CheckCTRStatus(status);
            }
        }
        ...
        public int FaultOverTemp
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetFault_OverTemp(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int FaultUnderVoltage
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetFault_UnderVoltage(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int FaultForwardLimit
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetFault_ForLim(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int FaultReverseLimit
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetFault_RevLim(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int FaultHardwareFailure
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetFault_HardwareFailure(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int FaultForwardSoftLimit
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetFault_ForSoftLim(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int FaultReverseSoftLimit
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetFault_RevSoftLim(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int StickyFaultOverTemp
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetStckyFault_OverTemp(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int StickyFaultUnderVoltage
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetStckyFault_UnderVoltage(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int StickyFaultForwardLimit
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetStckyFault_ForLim(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int StickyFaultReverseLimit
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetStckyFault_RevLim(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int StickyFaultForwardSoftLimit
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetStckyFault_ForSoftLim(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
        ...
        public int StickyFaultReverseSoftLimit
        {
            ...
            {
                int val = 0;
                CTR_Code status = ctre_TalonSRX_GetStckyFault_RevSoftLim(m_talonPointer, ref val);
                CheckCTRStatus(status);
                return val;
            }
        }
            ...
            if (m_controlEnabled)
            {
                ...
                switch (m_controlMode)
                {
                    case ControlMode.PercentVbus:
                        ctre_TalonSRX_Set(m_talonPointer, Inverted ? -value : value);
                        status = CTR_Code.CTR_OKAY;
                        break;
                    case ControlMode.Voltage:
                        int volts = (int)(value * 256);
                        status = ctre_TalonSRX_SetDemand(m_talonPointer, Inverted ? -volts : volts);
                        break;
                    case ControlMode.Position:
                        status = ctre_TalonSRX_SetDemand(m_talonPointer, ScaleRotationsToNativeUnits(m_feedbackDevice, value));
                        break;
                    case ControlMode.Speed:
                        status = ctre_TalonSRX_SetDemand(m_talonPointer,
                            ScaleVelocityToNativeUnits(m_feedbackDevice, Inverted ? -value : value));
                        break;
                    case ControlMode.Follower:
                        status = ctre_TalonSRX_SetDemand(m_talonPointer, (int)value);
                        break;
                    case ControlMode.Current:
                        double milliamperes = (Inverted ? -value : value) * 1000.0;
                        status = ctre_TalonSRX_SetDemand(m_talonPointer, (int)milliamperes);
                        break;
                    default:
                        status = CTR_Code.CTR_OKAY;
                        break;
                ...
                CheckCTRStatus(status);
                status = ctre_TalonSRX_SetModeSelect(m_talonPointer, (int)MotorControlMode);
                CheckCTRStatus(status);
        ...
        public virtual double Get()
        {
            ...
            switch (m_controlMode)
            {
                ...
                case ControlMode.Current:
                    ...
                    break;
                case ControlMode.Speed:
                    ctre_TalonSRX_GetSensorVelocity(m_talonPointer, ref value);
                    retVal = ScaleNativeUnitsToRpm(m_feedbackDevice, value);
                    break;
                case ControlMode.Position:
                    ctre_TalonSRX_GetSensorPosition(m_talonPointer, ref value);
                    retVal = ScaleNativeUnitsToRotations(m_feedbackDevice, value);
                    break;
                case ControlMode.Follower:
                case ControlMode.PercentVbus:
                default:
                    ctre_TalonSRX_GetAppliedThrottle(m_talonPointer, ref value);
                    retVal = value / 1023.0;
                    break;
            }
            return retVal;
        ...
        {
            ctre_TalonSRX_ChangeMotionControlFramePeriod(m_talonPointer, periodMs);
        }
        ...
        {
            ctre_TalonSRX_ClearMotionProfileTrajectories(m_talonPointer);
        }
        ...
        {
            return ctre_TalonSRX_GetMotionProfileTopLevelBufferCount(m_talonPointer);
        }
        ...
        public bool PushMotionProfileTrajectory(TrajectoryPoint trajPt)
        {
            ...
            if (timeDurMs < 0)
                timeDurMs = 0;
            CTR_Code status = ctre_TalonSRX_PushMotionProfileTrajectory(m_talonPointer, targPos, targVel, profileSlotSelect, timeDurMs, trajPt.VelocityOnly ? 1 : 0,
        ...
        {
            return ctre_TalonSRX_IsMotionProfileTopLevelBufferFull(m_talonPointer) != 0;
        }
        ...
        {
            ctre_TalonSRX_ProcessMotionProfileBuffer(m_talonPointer);
        }
        ...
        public MotionProfileStatus GetMotionProfileStatus()
        {
            ...
            int btmCnt = 0;
            int outEnable = 0;
            CTR_Code status = ctre_TalonSRX_GetMotionProfileStatus(m_talonPointer, ref flags, ref profileSelect,
